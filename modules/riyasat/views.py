"""
ماژول ریاست - داشبورد و مسیریابی
"""

from models.common import get_active_shift


def get_riyasat_dashboard(user):
    """داشبورد اصلی ریاست"""
   ...
   # shift_name = shift['tarkib'] if shift else 'نامشخص'
    ...
    # کارت‌های منو
    menu_cards = [
        {"title": "کارتابل ریاست", "icon": "📋", "desc": "بررسی گزارشات و صدور دستور", "url": "/module/riyasat/reports"},
...
def get_page(user, sub_page=None):
    """مسیریابی صفحات ریاست"""

    # ========== کارتابل ریاست ==========
    if sub_page == 'reports':
        from modules.riyasat.reports_form import get_riyasat_reports_form
        return get_riyasat_reports_form(user)

    # ========== زیرصفحه‌های در حال توسعه ==========
    sub_pages = {
        'management_reports': {'icon': '📊', 'title': 'گزارشات مدیریتی'},
    }
    ...
    if sub_page and sub_page in sub_pages:
        ...
        <div class="content-card fade-in">
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;">
                ...
                <a href="/module/riyasat" style="color:#3b82f6;font-weight:bold;">⬅️ بازگشت</a>
            </div>
    ...
    # ========== صفحه اصلی ==========
    return get_riyasat_dashboard(user)